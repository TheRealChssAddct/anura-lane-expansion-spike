...
create table facilities (
	period_name varchar(55),
	facility_unique_name varchar(55),
	facility_type varchar(55),
	facility_status varchar(55),
	facility_city varchar(55),
	facility_state varchar(55),
	facility_country varchar(55),
	facility_postal_code varchar(55),
	facility_latitude varchar(55),
	facility_longitude varchar(55),
	facility_fixed_operating_cost varchar(55),
